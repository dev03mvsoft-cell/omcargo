...
<style>
    ...
    .filter-input-group:focus-within { border-color: #000; box-shadow: 0 0 0 3px rgba(0,0,0,0.03); }
...
<main class="main-area">
    ...
    <header class="header" style="background: #fff; border-bottom: 1px solid #f1f5f9; padding: 25px var(--p-x); position: sticky; top: 0; z-index: 1000; display: flex; justify-content: space-between; align-items: center;">
        <div>
            <h2 style="font-size: 18px; font-weight: 900; color: #01172a; margin: 0; letter-spacing: -0.5px;">Transport Management</h2>
            <p style="font-size: 11px; color: #94a3b8; font-weight: 700; margin-top: 2px; text-transform: uppercase; letter-spacing: 0.5px;">Logistics Network & Fleet Registry</p>
        </div>
        <div style="display: flex; gap: 15px; align-items: center;">
            <div style="text-align: right; padding-right: 15px; border-right: 1px solid #e2e8f0;">
                <p style="font-size: 9px; font-weight: 800; color: #94a3b8; text-transform: uppercase; margin: 0;">Verified Fleet</p>
                <p style="font-size: 10px; color: #10b981; font-weight: 800; margin: 0;">42 PARTNERS ACTIVE</p>
            </div>
            <a href="create.php" class="btn" style="background: #2563eb; color: #fff; font-size: 13px; font-weight: 700; padding: 12px 25px; border-radius: 8px; text-decoration: none; display: flex; align-items: center; gap: 8px; box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.2);">
                <i class="fa-solid fa-plus"></i> ADD TRANSPORT PARTNER
            </a>
        </div>
    </header>
    ...
    <div class="content-padding" style="padding: 30px var(--p-x);">
        ...
        <div class="search-filter-hub" style="display: grid; grid-template-columns: 1fr 240px 180px; gap: 20px; margin-bottom: 30px;">
            <div class="filter-input-group">
                ...
                <input type="text" placeholder="Search Transport Company, Contact or Fleet ID..." style="width: 100%; border: none; outline: none; background: transparent; padding: 14px 14px 14px 48px; font-size: 13px; font-weight: 600;">
            </div>
            <div class="filter-input-group">
            ...
            <div class="card" style="padding: 24px; border: 1.5px solid #e2e8f0; border-radius: 12px; background: #fff; position: relative;">
                <div style="display: flex; justify-content: flex-start; align-items: flex-start; gap: 15px; margin-bottom: 15px;">
                    ...
                    <div style="flex: 1;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div>
                                <h4 style="font-size: 15px; font-weight: 900; margin: 0; color: #01172a; text-transform: uppercase;">AL-Maha Logistics</h4>
                                <p style="font-size: 10px; color: #94a3b8; font-weight: 800; margin-top: 4px; text-transform: uppercase;">ID: OMC-TRNS-882</p>
                            </div>
                            <span style="font-size: 8px; font-weight: 950; background: #f0fdf4; color: #16a34a; padding: 3px 8px; border-radius: 4px; border: 1px solid #dcfce7;">PREMIUM PARTNER</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 20px; padding-left: 31px;">
                    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 8px;">
                        ...
                        <span style="font-size: 11px; font-weight: 700; color: #475569;">ops@almaha-oman.net</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 8px;">
                        <i class="fa-solid fa-phone" style="font-size: 12px; color: #94a3b8; width: 14px;"></i>
                        <span style="font-size: 11px; font-weight: 700; color: #475569;">+968 2455 1200 / +968 9911 3455</span>
                    </div>
                    <div style="display: flex; align-items: start; gap: 10px;">
                        <i class="fa-solid fa-location-dot" style="font-size: 12px; color: #94a3b8; width: 14px; margin-top: 2px;"></i>
                        <span style="font-size: 11px; font-weight: 700; color: #475569; line-height: 1.4;">Bldg 441, Al-Khuwair, Muscat, Oman</span>
                    </div>
                </div>

                <div style="padding-top: 15px; border-top: 1px dashed #e2e8f0; display: grid; grid-template-columns: 1fr 1fr 50px; gap: 10px;">
                    <a href="view.php" style="text-align: center; text-decoration: none; padding: 10px; border-radius: 6px; background: #f8fafc; color: #64748b; font-size: 11px; font-weight: 850; border: 1.5px solid #e2e8f0;">STATS</a>
                    <a href="edit.php" class="btn" style="text-align: center; text-decoration: none; padding: 10px; border-radius: 6px; background: #2563eb; color: #fff; font-size: 11px; font-weight: 700; display: flex; align-items: center; justify-content: center; box-shadow: 0 4px 6px -1px rgba(37, 99, 235, 0.15);">CONFIGURE</a>
            ...
            <div class="card" style="padding: 24px; border: 1.5px solid #e2e8f0; border-radius: 12px; background: #fff; position: relative;">
                <div style="display: flex; justify-content: flex-start; align-items: flex-start; gap: 15px; margin-bottom: 15px;">
                    ...
                    <div style="flex: 1;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div>
                                <h4 style="font-size: 15px; font-weight: 900; margin: 0; color: #01172a; text-transform: uppercase;">Dhofar Express</h4>
                                <p style="font-size: 10px; color: #94a3b8; font-weight: 800; margin-top: 4px; text-transform: uppercase;">ID: OMC-TRNS-551</p>
                            </div>
                            <span style="font-size: 8px; font-weight: 950; background: #eff6ff; color: #2563eb; padding: 3px 8px; border-radius: 4px; border: 1px solid #dbeafe;">REGIONAL HUB</span>
                        </div>
                    </div>
                </div>
                ...
                <div style="margin-bottom: 20px; padding-left: 31px;">
                    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 8px;">
                        <i class="fa-solid fa-envelope" style="font-size: 12px; color: #94a3b8; width: 14px;"></i>
                        <span style="font-size: 11px; font-weight: 700; color: #475569;">info@dhofar-express.om</span>
                    </div>
                    <div style="display: flex; align-items: center; gap: 10px; margin-bottom: 8px;">
                        <i class="fa-solid fa-phone" style="font-size: 12px; color: #94a3b8; width: 14px;"></i>
                        <span style="font-size: 11px; font-weight: 700; color: #475569;">+968 2329 0011 / +968 9455 2200</span>
                    </div>
                    <div style="display: flex; align-items: start; gap: 10px;">
                        <i class="fa-solid fa-location-dot" style="font-size: 12px; color: #94a3b8; width: 14px; margin-top: 2px;"></i>
                        <span style="font-size: 11px; font-weight: 700; color: #475569; line-height: 1.4;">Salalah Industrial Area, Salalah, Oman</span>
                    </div>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    document.querySelectorAll('.delete-single-btn').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            if (confirm(`CRITICAL: Remove "${name}" from the logistics registry?`)) {
    ...
    if (bulkDeleteBtn) {
        bulkDeleteBtn.addEventListener('click', function() {
            ...
            if (confirm(`SECURITY ALERT: Permanently remove ${checked.length} transport partners from the directory?`)) {
                checked.forEach(cb => {
